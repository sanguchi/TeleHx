...
class TeleHxMethods {
	 ...
	 */
	public static function deleteWebhook(bot: TeleHxBot, ?callback: Bool -> Void): Void {
		sendApiRequest(bot, "deleteWebhook", function(response: HxApiResponse<Bool>){
			callback(response.result);
		});
	}
	/*
	 ...
	 */
	public static function getWebhookInfo(bot: TeleHxBot, ?callback: HxWebhookInfo -> Void): Void {
		sendApiRequest(bot, "getWebhookInfo", function(response: HxApiResponse<HxWebhookInfo>){
			callback(response.result);
		});
	}
	/*
	...
	public static function getMe(bot: TeleHxBot, ?callback: HxUser -> Void): Void {
		sendApiRequest(bot, "getMe", function(response: HxApiResponse<HxUser>){
			callback(response.result);
		});
	}
	/*
